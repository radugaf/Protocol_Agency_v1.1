...
import { agentsecondregistration } from "../../redux/actions/auth";
...
class AgencyRegistrationForm extends Component {
  ...
  onSubmit = (e) => {
    ...
    formData.append("agency_cover_photo", agency_cover_photo);
    formData.append("agency_contact_person", agency_contact_person);
    formData.append("business_certification", business_certification);

    console.log(formData);
    this.props.agentsecondregistration(formData);
  ...
  render() {
    ...
    const isagency = (auth && auth.user && auth.user.is_agency) || false;
    ...
    return (
      <div className="row card card-body mt-4 mb-4">
        <p className="h5 text-center mb-4">Agency Registration Form </p>
        <form className="col-6 offset-3" onSubmit={this.onSubmit}>
          {isagency && (
            <>
              ...
              <div className="form-group ">
                <label for="male">Agency Contact Person National ID</label>
                <input
                  required
                  className="form-control"
                  placeholder="Upload Agency Contact Person National ID"
                  type="file"
                  name="agency_contact_person"
                  id="agency_contact_person"
                  onChange={this.handleImageChange}
                />
              </div>

              <div className="form-group">
                <label for="male">Upload Agency Cover Photo</label>
                <input
                  className="form-control"
                  placeholder="Upload Agency Cover Photo"
                  type="file"
                  name="agency_cover_photo"
                  id="agency_cover_photo"
                  required
                  onChange={this.handleImageChange}
                />
              </div>
          ...
          <div className="form-group ">
            ...
            <input
              required
              className="form-control"
              placeholder="Upload Agency Profile Photo"
              type="file"
              name="profile_photo"
              id="profile_photo"
              onChange={this.handleImageChange}
...
export default connect(mapStateToProps, { agentsecondregistration })(
