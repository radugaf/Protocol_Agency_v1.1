...
APPS_DIR = BASE_DIR / "protocol_crm"
...
MIGRATION_MODULES = {
    "sites": "protocol_crm.contrib.sites.migrations"
}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "protocol_crm.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("Radu Gafita", "radugaf@gmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "protocol_crm.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = (
    "protocol_crm.users.adapters.SocialAccountAdapter"
)
